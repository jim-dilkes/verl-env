...
class TaskRunner:
    ...
    def run(self, config):
        ...
        # Route to appropriate trainer based on multistep environment configuration
        if config.envs.get("enable", False):
            # Use multistep trainer for environment-based multistep training
            from verl.trainer.ppo.ray_multistep_trainer import RayMultistepTrainer
            print("Using RayMultistepTrainer for multistep environment training")
            ...
            # Use standard PPO trainer for single-step training
            print("Using RayPPOTrainer for standard single-step training")
